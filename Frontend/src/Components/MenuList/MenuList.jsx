...
const MenuList = ({category, setCategory}) => {
  ...
  return (
    <div className='explore-menu'>
        <h2 className="explore-menu-heading text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Explore our menu</h2>
        <p className='text-xs text-gray-300 sm:text-sm md:text-[16px]'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Natus voluptatem eos optio laudantium veritatis!</p>
